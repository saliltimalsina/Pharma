...
const mainListItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { text: 'Advances', path: '/finance/advances' },
      { text: 'Accounting', path: '/finance/accounting' },
      { text: 'Banking', path: '/finance/banking' },
      { text: 'Cash Book', path: '/finance/cash-book' },
      { text: 'Taxes', path: '/finance/taxes' },
      { text: 'Financial Reports', path: '/finance/reports' },
      { text: 'Analytics', path: '/finance/analytics' },
      { text: 'Audit Report', path: '/finance/audit' },
    ],
  },
];
